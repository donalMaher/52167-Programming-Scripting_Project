...
The model to separate and classify the species could be as simple as:
"If(petal_lenght is less than or equal to 2 and petal_width is less than or equal to 0.75):
 species = setosaElse if :
 (petal_lenght is than 2 and petal_width is less than or equal to 1.65) 
 species= versicolorElse: species= virginica"
